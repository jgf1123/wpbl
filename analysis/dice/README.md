...
| `tired_card.py` | What a tired column costs and looks like, in cells | one cell is 1/94 = +0.013 runs/BF, not 1/33. G3's full shift is +0.032 and moves 3 of her 33 cells; reaching the +0.09 step needs 2.82x G3 and prints an absurd card |
